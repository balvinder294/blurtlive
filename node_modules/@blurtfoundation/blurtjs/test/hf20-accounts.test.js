...
describe("blurt.hf20-accounts:", () => {
    it("has generated methods", () => {
        should.exist(blurt.broadcast.claimAccount);
        should.exist(blurt.broadcast.createClaimedAccount);
    });

    it("has promise methods", () => {
        should.exist(blurt.broadcast.claimAccountAsync);
        should.exist(blurt.broadcast.createClaimedAccountAsync);
    });
