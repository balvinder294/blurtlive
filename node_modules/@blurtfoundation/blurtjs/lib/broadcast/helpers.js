...
exports = module.exports = function (steemBroadcast) {
  steemBroadcast.addAccountAuth = function (_ref, cb) {
    ...
    _api2.default.getAccounts([username], function (err, _ref2) {
      ...
      steemBroadcast.accountUpdate(signingKey, userAccount.name, owner, active, posting, userAccount.memo_key, userAccount.json_metadata, userAccount.posting_json_metadata, null, cb);
    });
  };
