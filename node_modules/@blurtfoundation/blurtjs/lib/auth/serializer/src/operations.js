...
var comment_payout_blurt = new Serializer(1, {
...
var allowed_vote_assets = new Serializer(2, {
...
var comment_options = new Serializer("comment_options", {
  ...
  allow_votes: bool,
  allow_curation_rewards: bool,
  extensions: set(static_variant([comment_payout_beneficiaries, comment_payout_blurt]))
});
