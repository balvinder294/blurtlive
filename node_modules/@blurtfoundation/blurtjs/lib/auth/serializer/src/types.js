...
Types.asset = {
  fromByteBuffer: function fromByteBuffer(b) {
    ...
    if (precision >= 16) {
      ...
      var nai = Buffer.from(b_copy.toBinary(), "binary").readInt32();
      nai = nai / 32;
      ...
      symbol = Buffer.from(_b_copy.toBinary(), "binary").toString().replace(/\x00/g, "");
      b.skip(7);
...
Types.asset_symbol = {
  fromByteBuffer: function fromByteBuffer(b) {
    ...
    if (precision >= 16) {
      ...
      var symbol = Buffer.from(_b_copy2.toBinary(), "binary").toString().replace(/\x00/g, "");
