...
var Blurt = function (_EventEmitter) {
    _inherits(Blurt, _EventEmitter);

    function Blurt() {
        var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

        _classCallCheck(this, Blurt);

        var _this = _possibleConstructorReturn(this, (Blurt.__proto__ || Object.getPrototypeOf(Blurt)).call(this, options));
    ...
    _createClass(Blurt, [{
        ...
        value: function notifyError(err) {
            ...
            if (err && err.toString().includes("overseer")) {
                // overseer was a Steem thing, it doesn't exist in Blurt, so don't count this error towards failover
                return;
            }
            this.error_count++;
...
var blurt = new Blurt(_config2.default);
