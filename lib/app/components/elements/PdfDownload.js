...
var PdfDownload = /*#__PURE__*/function (_Component) {
  (0, _inherits2["default"])(PdfDownload, _Component);

  var _super = _createSuper(PdfDownload);
  ...
  (0, _createClass2["default"])(PdfDownload, [{
    ...
    value: function renderPdf(keys, filename) {
      ...
      */
      ...
      offset = sectionStart + sectionHeight; // BODY
      ...
      */
      ...
      offset += 0.2;
      offset = sectionStart + sectionHeight; // MEMO KEY

      sectionStart = offset;
      sectionHeight = qrSize + 0.15 * 2; // this.drawFilledRect(ctx, 0.0, offset, widthInches, sectionHeight, {color: '#f4f4f4'});
      ...
      offset += 0.1;
      offset = sectionStart + sectionHeight; // ACTIVE KEY
      ...
      offset += 0.2;
      offset = sectionStart + sectionHeight; // OWNER KEY
      ...
      offset = sectionStart + sectionHeight; // MASTER PASSWORD
      ...
      offset = sectionStart + sectionHeight; // PUBLIC KEYS INTRO

      sectionStart = offset;
      sectionHeight = 1.0; // this.drawFilledRect(ctx, 0.0, offset, widthInches, sectionHeight, {color: '#f4f4f4'});
      ...
      offset = sectionStart + sectionHeight; // PUBLIC KEYS
