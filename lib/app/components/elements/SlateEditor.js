...
var serializeHtml = function serializeHtml(state) {
...
var getDemoState = function getDemoState() {
...
var SlateEditor = /*#__PURE__*/function (_React$Component) {
  ...
  function SlateEditor(_props) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "onClickBlock", function (e, type) {
      ...
      var _state = state,
          document = _state.document; // Handle everything but list buttons.
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "onShiftEnter", function (e, state) {
      ...
      var startBlock = state.startBlock,
          ...
          endOffset = state.endOffset; // Allow soft returns for certain block types
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "onEnter", function (e, state) {
      ...
      var startBlock = state.startBlock,
          startOffset = state.startOffset,
          endOffset = state.endOffset; // On return, if at the end of a node type that should not be extended, create a new paragraph below it.
