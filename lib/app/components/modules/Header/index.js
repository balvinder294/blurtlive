...
var Header = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2["default"])(Header, [{
    ...
    value: function render() {
      ...
      var logo_link = (0, _ResolveRoute["default"])(pathname).params && (0, _ResolveRoute["default"])(pathname).params.length > 1 && this.last_sort_order ? '/' + this.last_sort_order : current_account_name ? "/@".concat(current_account_name, "/feed") : '/'; //TopRightHeader Stuff

      var defaultNavigate = function defaultNavigate(e) {
        if (e.metaKey || e.ctrlKey) {// prevent breaking anchor tags
        } else {
          e.preventDefault();
        }
