...
var Post = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2["default"])(Post, [{
    ...
    value: function render() {
      ...
      var dis = content.get(post); // check if the post doesn't exist
      ...
      if (emptyPost) return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        href: "/active"
      }, "active posts"))))); // TODO: This data model needs some help.

      var post_content = content.get(post);
      var p = (0, _ExtractContent["default"])(_Accessors.immutableAccessor, post_content);
      var tags = p.json_metadata.tags; // A post should be hidden if it is not special, is not told to "show
      ...
      (0, _Comment.sortComments)(content, replies, sortOrder); // Don't render too many comments on server-side
