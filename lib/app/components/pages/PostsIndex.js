...
var _Contests = _interopRequireDefault(require("app/components/elements/Contests"));
...
var PostsIndex = /*#__PURE__*/function (_React$Component) {
  ...
  var _super = _createSuper(PostsIndex);
  ...
  (0, _createClass2["default"])(PostsIndex, [{
    ...
    value: function render() {
      ...
      var showSpam = this.state.showSpam; // If we're at one of the four sort order routes without a tag filter,
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        bandwidthKbytesFee: this.props.bandwidthKbytesFee.toFixed(3),
        operationFlatFee: this.props.operationFlatFee.toFixed(3),
        pricePerBlurt: this.props.pricePerBlurt
      })), /*#__PURE__*/_react["default"].createElement(_Notices["default"], {
        notices: this.props.notices
      }), /*#__PURE__*/_react["default"].createElement(_Contests["default"], {
...
module.exports = {
  ...
  component: (0, _reactRedux.connect)(function (state, ownProps) {
    ...
    return {
      ...
      contests: state.offchain.get('special_posts').get('contests').toJS(),
