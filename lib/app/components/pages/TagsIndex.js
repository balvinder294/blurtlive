...
var TagsIndex = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2["default"])(TagsIndex, [{
    ...
    value: function render() {
      ...
      var tagsAll = this.props.tagsAll; //console.log('-- TagsIndex.render -->', tagsAll.toJS());

      var order = this.state.order;
      var tags = tagsAll;
      var rows = tags.filter( // there is a blank tag present, as well as some starting with #. filter them out.
      function (tag) {
