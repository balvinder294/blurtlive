...
var UserProfile = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2["default"])(UserProfile, [{
    ...
    value: function render() {
      ...
      if (!section) section = 'blog'; // Loading status
      ...
      var following = follow && follow.getIn(['getFollowingAsync', accountname]); // get avatar

      var profile = {};

      if (accountImm.toJS() && accountImm.toJS().json_metadata) {
        var metaData = accountImm ? JSON.parse(accountImm.toJS().json_metadata) : {};
      ...
      }, top_menu), section && section === 'blog' && profile.avatarUrl ? /*#__PURE__*/_react["default"].createElement("div", {
        className: "avatar"
