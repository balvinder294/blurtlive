...
describe('Global reducer', function () {
  it('should provide a nice initial state', function () {
    ...
    expect(initial).toEqual(globalActions.defaultState);
  });
  it('should return correct state for a SET_COLLAPSED action', function () {
    ...
    var initial = (0, globalActions["default"])().set('content', (0, _immutable.Map)((0, _defineProperty2["default"])({}, payload.post, (0, _immutable.Map)({})))); // Act

    var actual = (0, globalActions["default"])(initial, globalActions.setCollapsed(payload)); // Assert
  ...
  it('should return correct state for a RECEIVE_STATE action', function () {
    ...
    var initial = (0, globalActions["default"])(); // Act

    var actual = (0, globalActions["default"])(initial, globalActions.receiveState(payload)); // Assert
  ...
  it('should return correct state for a RECEIVE_ACCOUNT action', function () {
    ...
    var actual = (0, globalActions["default"])(initial, globalActions.receiveAccount(payload)); // Assert
  ...
  it('should return correct state for a RECEIVE_ACCOUNTS action', function () {
    ...
    var actual = (0, globalActions["default"])(initial, globalActions.receiveAccounts(payload)); // Assert
  ...
  it('should return correct state for a RECEIVE_CONTENT action', function () {
    ...
    var _payload$content = payload.content,
        ...
        active_votes = _payload$content.active_votes; // Act

    var actual = (0, globalActions["default"])((0, globalActions["default"])(), globalActions.receiveContent(payload)); // Assert
  ...
  it('should return correct state for a LINK_REPLY action', function () {
    ...
    var actual = (0, globalActions["default"])(initial, globalActions.linkReply(payload)); // Assert

    expect(actual.get('content')).toEqual(expected); // Arrange
    // Remove parent

    payload.parent_author = ''; // Act

    actual = (0, globalActions["default"])(initial, globalActions.linkReply(payload)); // Assert
  ...
  it('should return correct state for a DELETE_CONTENT action', function () {
    ...
    var expected = (0, _immutable.Map)({}); // Act

    var actual = (0, globalActions["default"])(initWithContent, globalActions.deleteContent(payload)); // Assert
    ...
    actual = (0, globalActions["default"])(initWithParentKeyContent, globalActions.deleteContent(payload)); // Assert
  ...
  it('should return correct state for a FETCHING_DATA action', function () {
    ...
    var initWithCategory = (0, globalActions["default"])().set('status', (0, _immutable.Map)((0, _defineProperty2["default"])({}, payload.category, (0, _immutable.Map)((0, _defineProperty2["default"])({}, payload.order, {
      fetching: false
    }))))); // Act

    var actual = (0, globalActions["default"])(initWithCategory, globalActions.fetchingData(payload)); // Assert
  ...
  it('should return correct state for a RECEIVE_DATA action', function () {
    ...
    var initWithData = (0, globalActions["default"])().merge({
      ...
      discussion_idx: (0, _immutable.Map)((_Map9 = {}, (0, _defineProperty2["default"])(_Map9, payload.category, (0, _immutable.Map)({
      ...
      })), (0, _defineProperty2["default"])(_Map9, '', (0, _immutable.Map)({
        FebrileFriday: (0, _immutable.List)([])
      })), _Map9))
    }); // Act

    var actual1 = (0, globalActions["default"])(initWithData, globalActions.receiveData(payload));
    var postKey = "".concat(postData.author, "/").concat(postData.permlink); // Assert
    ...
    expect(actual1.getIn(['content', postKey, 'active_votes'])).toEqual((0, _immutable.fromJS)(postData.active_votes)); // Push new key to posts list, If order meets the condition.
    ...
    payload.order = 'UnusualOrder'; // Act.
    // Push new key to discussion_idx list, If order does not meet the condition.

    var actual2 = (0, globalActions["default"])(initWithData, globalActions.receiveData(payload)); // Assert
    ...
    payload.category = ''; // Act

    var actual3 = (0, globalActions["default"])(initWithData, globalActions.receiveData(payload)); // Assert.
  ...
  it('should handle fetch status for a RECEIVE_DATA action', function () {
    ...
    var initWithData = (0, globalActions["default"])().merge({
      ...
      content: (0, _immutable.Map)({}),
      status: (0, _immutable.Map)((0, _defineProperty2["default"])({}, payload.category, (0, _immutable.Map)((0, _defineProperty2["default"])({}, payload.order, {})))),
      discussion_idx: (0, _immutable.Map)((_Map14 = {}, (0, _defineProperty2["default"])(_Map14, payload.category, (0, _immutable.Map)({
        UnusualOrder: (0, _immutable.List)([{
          data: {
            author: 'ship',
            permlink: 'bridge'
      ...
      })), (0, _defineProperty2["default"])(_Map14, '', (0, _immutable.Map)({
        FebrileFriday: (0, _immutable.List)([])
      })), _Map14))
    }); // Act

    var actual1 = (0, globalActions["default"])(initWithData, globalActions.receiveData(payload)); // Assert

    expect(actual1.getIn(['status', payload.category, payload.order]).fetching).toBeFalsy();
    expect(actual1.getIn(['status', payload.category, payload.order]).last_fetch).toBeFalsy(); // Arrange

    payload.fetching = true; // Act.

    var actual2 = (0, globalActions["default"])(initWithData, globalActions.receiveData(payload)); // Assert

    expect(actual2.getIn(['status', payload.category, payload.order]).fetching).toBeTruthy();
    expect(actual2.getIn(['status', payload.category, payload.order]).last_fetch).toBeFalsy(); // Arrange

    payload.endOfData = true; // Act

    var actual3 = (0, globalActions["default"])(initWithData, globalActions.receiveData(payload)); // Assert.

    expect(actual3.getIn(['status', payload.category, payload.order]).fetching).toBeTruthy();
    expect(actual3.getIn(['status', payload.category, payload.order]).last_fetch).toBeTruthy(); // Arrange

    payload.fetching = false; // Act

    var actual4 = (0, globalActions["default"])(initWithData, globalActions.receiveData(payload)); // Assert.
  ...
  it('should return correct state for a SET action', function () {
    ...
    var actual = (0, globalActions["default"])(initial, globalActions.set(payload)); // Assert

    expect(actual.getIn(payload.key)).toEqual(payload.value); // Arrange
  ...
  it('should return correct state for a REMOVE action', function () {
    ...
    var initial = (0, globalActions["default"])();
    initial.setIn(payload.key, 'potato'); // Act

    var actual = (0, globalActions["default"])(initial, globalActions.remove(payload)); // Assert
  ...
  it('should return correct state for a UPDATE action', function () {
    ...
    var initial = (0, globalActions["default"])();
    initial.setIn(payload.key, 'acorn'); // Act

    var actual = (0, globalActions["default"])(initial, globalActions.update(payload)); // Assert

    expect(actual.getIn(payload.key)).toEqual(payload.updater());
  });
  it('should return correct state for a FETCH_JSON action', function () {
    var initial = (0, globalActions["default"])();
    var actual = (0, globalActions["default"])(initial, globalActions.fetchJson(globalActions.defaultState));
  ...
  it('should return correct state for a SHOW_DIALOG action', function () {
    ...
    var initial = (0, globalActions["default"])().set('active_dialogs', (0, _immutable.Map)({
      chimney: 'smoke'
    }));
  ...
  it('should return correct state for a HIDE_DIALOG action', function () {
    ...
    var initial = (0, globalActions["default"])().set('active_dialogs', (0, _immutable.Map)((0, _defineProperty2["default"])({}, payload.name, 'flipper')));
