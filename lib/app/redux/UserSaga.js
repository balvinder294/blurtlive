...
var _marked = /*#__PURE__*/_regeneratorRuntime2.mark(shouldShowLoginWarning),
    _marked2 = /*#__PURE__*/_regeneratorRuntime2.mark(checkKeyType),
    _marked3 = /*#__PURE__*/_regeneratorRuntime2.mark(usernamePasswordLogin),
    _marked4 = /*#__PURE__*/_regeneratorRuntime2.mark(usernamePasswordLogin2),
    _marked5 = /*#__PURE__*/_regeneratorRuntime2.mark(saveLogin_localStorage),
    _marked6 = /*#__PURE__*/_regeneratorRuntime2.mark(logout),
    _marked7 = /*#__PURE__*/_regeneratorRuntime2.mark(loginError),
    _marked8 = /*#__PURE__*/_regeneratorRuntime2.mark(lookupPreviousOwnerAuthority),
    _marked9 = /*#__PURE__*/_regeneratorRuntime2.mark(uploadImage);

var userWatches = [(0, _effects.takeLatest)('user/lookupPreviousOwnerAuthority', lookupPreviousOwnerAuthority), (0, _effects.takeLatest)(userActions.CHECK_KEY_TYPE, checkKeyType), (0, _effects.takeLatest)(userActions.USERNAME_PASSWORD_LOGIN, usernamePasswordLogin), (0, _effects.takeLatest)(userActions.SAVE_LOGIN, saveLogin_localStorage), (0, _effects.takeLatest)(userActions.LOGOUT, logout), (0, _effects.takeLatest)(userActions.LOGIN_ERROR, loginError), (0, _effects.takeLatest)(userActions.UPLOAD_IMAGE, uploadImage), (0, _effects.takeLatest)(userActions.ACCEPT_TERMS, /*#__PURE__*/_regenerator["default"].mark(function _callee() {
...
exports.userWatches = userWatches;

function shouldShowLoginWarning(_ref) {
  var username, password, account, pubKey, postingPubKeys;
  return _regenerator["default"].wrap(function shouldShowLoginWarning$(_context3) {
    while (1) {
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          ...
          if (typeof sessionStorage === 'undefined' || typeof sessionStorage !== 'undefined' && sessionStorage.getItem('hideAnnouncement') !== 'true') {// Uncomment to re-enable announcment
...
function usernamePasswordLogin2(_ref2) {
  var username, password, useKeychain, saveLogin, operationType, afterLoginRedirectToWelcome, user, loginType, justLoggedIn, feedURL, autopost, memoWif, login_owner_pubkey, login_wif_owner_pubkey, login_with_keychain, data, _extractLoginData, _extractLoginData2, offchain_account, userProvidedRole, _username$split, _username$split2, pathname, isRole, account, private_keys, private_key, authority, hasActiveAuth, hasOwnerAuth, accountName, fullAuths, owner_pub_key, generated_type, owner_pubkey, active_pubkey, posting_pubkey, memo_pubkey, offchainData, serverAccount, challengeString, signatures, challenge, buf, bufSha, _response, sign, response, body;

  return _regenerator["default"].wrap(function usernamePasswordLogin2$(_context6) {
    while (1) {
      switch (_context6.prev = _context6.next) {
        case 0:
          username = _ref2.username, password = _ref2.password, useKeychain = _ref2.useKeychain, saveLogin = _ref2.saveLogin, operationType = _ref2.operationType, afterLoginRedirectToWelcome = _ref2.afterLoginRedirectToWelcome;
          _context6.next = 3;
          return (0, _effects.select)(function (state) {
            return state.user;
          });
        ...
        case 3:
          ...
          console.log('Login type:', loginType, 'Just logged in?', justLoggedIn, 'username:', username); // login, using saved password
        ...
        case 97:
          ...
          if (username) feedURL = '/@' + username + '/feed'; // Keep the posting key in RAM but only when not signing an operation.
        ...
        case 134:
          ...
          sign('posting', private_keys.get('posting_private')); // sign('active', private_keys.get('active_private'))
        ...
        case 145:
          _context6.prev = 145;
          _context6.t0 = _context6["catch"](106);
        ...
        case 151:
          // Feature Flags
          if (useKeychain || private_keys.get('posting_private')) {// yield fork(
            //     getFeatureFlags,
            //     username,
    ...
    while (1) {
      switch (_context8.prev = _context8.next) {
        case 0:
          ...
          console.log('Logging out', _args8, 'logout type', logoutType); // Just in case it is still showing
...
function loginError(_ref3) {
  return _regenerator["default"].wrap(function loginError$(_context9) {
    while (1) {
...
function lookupPreviousOwnerAuthority(_ref4) {
  ...
  return _regenerator["default"].wrap(function lookupPreviousOwnerAuthority$(_context10) {
    while (1) {
...
function uploadImage(_ref5) {
  var _ref5$payload, file, dataUrl, _ref5$payload$filenam, filename, progress, _progress, stateUser, username, keychainLogin, d, data, dataBs64, reader, commaIdx, prefix, buf, bufSha, formData, sig, response, postUrl, xhr;

  return _regenerator["default"].wrap(function uploadImage$(_context11) {
    while (1) {
      switch (_context11.prev = _context11.next) {
        case 0:
          _ref5$payload = _ref5.payload, file = _ref5$payload.file, dataUrl = _ref5$payload.dataUrl, _ref5$payload$filenam = _ref5$payload.filename, filename = _ref5$payload$filenam === void 0 ? 'image.txt' : _ref5$payload$filenam, progress = _ref5$payload.progress;
          _progress = progress;
