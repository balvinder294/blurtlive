...
var emptyContentMap = (0, _immutable.Map)(_EmptyState.emptyContent);
exports.emptyContentMap = emptyContentMap;
...
var HIDE_DIALOG = 'global/HIDE_DIALOG'; // Saga-related:

var GET_STATE = 'global/GET_STATE';
...
function reducer() {
  ...
  var payload = action.payload; // Set post category
    ...
    case LINK_REPLY:
      {
        ...
        var parent_key = parent_author + '/' + parent_permlink; // Add key if not exist
    ...
    case RECEIVE_DATA:
      {
        ...
        var _new_state2; // append incoming post keys to proper content list
...
var setCollapsed = function setCollapsed(payload) {
  return {
    type: SET_COLLAPSED,
    payload: payload
  };
...
exports.setCollapsed = setCollapsed;

var receiveState = function receiveState(payload) {
  return {
    type: RECEIVE_STATE,
    payload: payload
  };
...
exports.receiveState = receiveState;

var receiveAccount = function receiveAccount(payload) {
  return {
...
var receiveAccounts = function receiveAccounts(payload) {
  return {
...
exports.receiveAccounts = receiveAccounts;

var syncSpecialPosts = function syncSpecialPosts(payload) {
  return {
...
exports.syncSpecialPosts = syncSpecialPosts;

var receiveContent = function receiveContent(payload) {
  return {
...
var linkReply = function linkReply(payload) {
  return {
    type: LINK_REPLY,
    payload: payload
  };
...
exports.linkReply = linkReply;

var deleteContent = function deleteContent(payload) {
  return {
    type: DELETE_CONTENT,
    payload: payload
  };
...
var voted = function voted(payload) {
  return {
    type: VOTED,
    payload: payload
  };
...
var fetchingData = function fetchingData(payload) {
  return {
    type: FETCHING_DATA,
    payload: payload
  };
...
var fetchJson = function fetchJson(payload) {
  return {
    type: FETCH_JSON,
    payload: payload
  };
...
var fetchJsonResult = function fetchJsonResult(payload) {
  return {
...
exports.fetchJsonResult = fetchJsonResult;

var showDialog = function showDialog(payload) {
  return {
    type: SHOW_DIALOG,
    payload: payload
  };
...
var hideDialog = function hideDialog(payload) {
  return {
    type: HIDE_DIALOG,
    payload: payload
  };
...
var getState = function getState(payload) {
  return {
    type: GET_STATE,
    payload: payload
  };
...
var receiveUnreadNotifications = function receiveUnreadNotifications(payload) {
  return {
...
exports.receiveUnreadNotifications = receiveUnreadNotifications;