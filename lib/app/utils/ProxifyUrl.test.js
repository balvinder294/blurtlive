...
describe('ProxifyUrl', function () {
  ...
  it('preserve dimensions - double-proxied URL', function () {
    ...
    testCase('https://imgp.blurt.world/1001x2001/https://imgp.blurt.world//0x0/https://example.com/img.png', true, 'https://imgp.blurt.world//1001x2001/https://example.com/img.png'); // blurt domain
  ...
  it('preserve dimensions - strip proxies & dimensions when appropriate', function () {
    // simple preservation at a 2 nesting level
    // blurt domain
    testCase('https://imgp.blurt.world//0x0/https://imgp.blurt.world//DQmaJe2Tt5kmVUaFhse1KTEr4N1g9piMgD3YjPEQhkZi3HR/30day-positivity-challenge.jpg', true, 'https://imgp.blurt.world//DQmaJe2Tt5kmVUaFhse1KTEr4N1g9piMgD3YjPEQhkZi3HR/30day-positivity-challenge.jpg'); // foreign domain

    testCase('https://imgp.blurt.world//0x0/https://example.com/img.png', true, 'https://imgp.blurt.world//640x0/https://example.com/img.png'); // case where last is natural sizing, assumes natural sizing - straight to direct blurt file url

    testCase('https://imgp.blurt.world//0x0/https://imgp.blurt.world//100x100/https://imgp.blurt.world//DQmaJe2Tt5kmVUaFhse1KTEr4N1g9piMgD3YjPEQhkZi3HR/30day-positivity-challenge.jpg', true, 'https://imgp.blurt.world//DQmaJe2Tt5kmVUaFhse1KTEr4N1g9piMgD3YjPEQhkZi3HR/30day-positivity-challenge.jpg'); // case where last is natural sizing, assumes natural sizing - straight to direct blurt /0x0/ domain host url
