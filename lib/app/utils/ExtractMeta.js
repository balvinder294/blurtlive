...
function extractMeta(chain_data, rp) {
  ...
  if (rp.username && rp.slug) {
    ...
    var content = chain_data.content[post]; // const author = chain_data.accounts[rp.username];
    ...
    if (content && content.id !== '0.0.0') {
      ...
      var url = 'https://blurt.blog' + d.link;
      var canonicalUrl = (0, _CanonicalLinker.makeCanonicalLink)(d);
      var title = d.title + ' — Blurt';
      var desc = d.desc + ' by ' + d.author;
      var image = d.image_link || 'https://blurt.blog/images/Blurtlogo.png';
      var category = d.category,
          created = d.created; // Standard meta
    ...
    var _image = profile_image; // Standard meta
