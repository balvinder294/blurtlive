...
var addToParams = function addToParams(outputParams, inputParams, key, allowedValues) {
...
var makeParams = function makeParams(params, prefix) {
  var paramsList = [];
...
var determineViewMode = function determineViewMode(search) {
...
exports.determineViewMode = determineViewMode;