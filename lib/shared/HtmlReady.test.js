...
describe('htmlready', function () {
  ...
  it('should not allow links where the text portion contains blurt.world but the link does not', function () {
    ...
    expect(resnoendingslash).toEqual(cleansednoendingslash); // make sure extra-domain in-page links are also caught by our phishy link scan.
    ...
    expect(resDomainInpage).toEqual(cleanDomainInpage); // anchor links including blurt.world should be allowed
