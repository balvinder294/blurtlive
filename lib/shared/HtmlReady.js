...
exports.getPhishingWarningMessage = getPhishingWarningMessage;
...
exports.getExternalLinkWarningMessage = getExternalLinkWarningMessage;
...
function iframe(state, child) {
  var url = child.getAttribute('src'); // @TODO move this into the centralized EmbeddedPlayer code
...
function linkify(content, mutate, hashtags, usertags, images, links) {
  ...
  content = content.replace((0, _Links.any)('gi'), function (ln) {
    ...
    if (/\.(zip|exe)$/i.test(ln)) return ln; // do not linkify phishy links
