...
var _marked = /*#__PURE__*/_regenerator["default"].mark(verify);
...
function verify(_ref) {
  var mobile, confirmation_code, ip, ignore_score, result, _result$risk, recommendation, score, phone, sms, _yield$verifySms, reference_id;

  return _regenerator["default"].wrap(function verify$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          mobile = _ref.mobile, confirmation_code = _ref.confirmation_code, ip = _ref.ip, ignore_score = _ref.ignore_score;
          _context.prev = 1;
          _context.next = 4;
...
function verifySms(_ref2) {
  ...
  var fields = urlencode(f); // console.log('fields', fields) // logspam
