 ...
 */
var StatsLoggerClient = /*#__PURE__*/function () {
  function StatsLoggerClient(STATSD_IP) {
    ...
    if (STATSD_IP) {
      ...
      console.log('StatsLoggerClient: no server available, logging to console.'); // Implement debug loggers here, as any new calls are added in methods below.
